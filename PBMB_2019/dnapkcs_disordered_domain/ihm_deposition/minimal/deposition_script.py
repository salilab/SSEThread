...
class Model(ihm.model.Model):
    ...
    def get_crosslink_coordinates(self, ps_coords):
      # Each crosslink will have two coordinates. These coordiantes are either from a modeled residue
...
models = []
for pdb_file in glob.glob("./bsms.pdb")[0:1]:
    #print(pdb_file)
